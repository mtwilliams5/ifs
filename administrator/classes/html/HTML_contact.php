	...
	class HTML_contact {
      ...
      <TD COLSPAN="4" CLASS="heading" HEIGHT="20">&nbsp;Contact Details</TD>
			...
			<TR>
				...
				<TD COLSPAN="3" WIDTH="85%"><INPUT TYPE="text" NAME="companyname" SIZE="25" VALUE="<?php
echo $companyname; ?>"></TD>	
			</TR>
			<TR>
				<TD WIDTH="120">Company Number:</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="acn" SIZE="15" VALUE="<?php
echo $acn; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Address:</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="address" SIZE="25" VALUE="<?php
echo $address; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Town/City:</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="suburb" SIZE="25" VALUE="<?php
echo $suburb; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="120">State:</TD>
				<TD WIDTH="100"><INPUT TYPE="text" NAME="state" SIZE="15" VALUE="<?php
echo $state; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="120">Country:</TD>
				<TD WIDTH="100"><INPUT TYPE="text" NAME="country" SIZE="15" VALUE="<?php
echo $country; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Postcode/ZIP:</TD>
				<TD WIDTH="100"><INPUT TYPE="text" NAME="postcode" VALUE="<?php
echo $postcode; ?>" SIZE="10"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Telephone:</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="telephone" SIZE="15" VALUE="<?php
echo $telephone; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Facsimile</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="facsimile" SIZE="15" VALUE="<?php
echo $facsimile; ?>"></TD>
			</TR>
			<TR>
				<TD WIDTH="100">Email To:</TD>
				<TD COLSPAN="3"><INPUT TYPE="text" NAME="email" SIZE="25" VALUE="<?php
echo $email; ?>"></TD>
			</TR>
			<TR>
