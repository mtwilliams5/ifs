					...
					<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
						...
						<TR>
							<?php if ($PageSource!="Link"){?>
								<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:submitbutton('savenew<?php echo $PageSource;?>', 'topsection');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('save','','../images/admin/save_f2.gif',1);"><IMG SRC="../images/admin/save.gif" ALT="Publish" WIDTH="36" HEIGHT="47" BORDER="0" NAME="save" HSPACE="5" VPSACE="0"></A></TD>
			    			<?php
}?>
