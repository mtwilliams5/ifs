...
/**	
	...
	**/
	...
	class menuthreads {
		function NEW_MENU_Threads($forum, $act, $option){ ?>
...
include ("menubar/mainmenu.php"); ?></TD>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="99%" BGCOLOR="#999999">
					<TR>
    					<td width="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><a href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to publish'); } else {submitbutton('publish', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('publish','','../images/admin/publish_f2.gif',1);"><img name="publish" src="../images/admin/publish.gif" width="32" HEIGHT="47" border="0" HSPACE="10" VPSACE="0"></a></td>
						<td width="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><a href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to unpublish'); } else {submitbutton('unpublish', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('Unpublish','','../images/admin/Unpublish_f2.gif',1);" ><img name="Unpublish" src="../images/admin/Unpublish.gif" width="45" HEIGHT="47" border="0" HSPACE="10" VPSACE="0"></a></td>
						<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to archive'); } else {submitbutton('archive', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('archive','','../images/admin/archive_f2.gif',1);"><IMG SRC="../images/admin/archive.gif" ALT="Archive" WIDTH="35" HEIGHT="47" BORDER="0" NAME="archive" HSPACE="10" VPSACE="0"></A></TD>
						<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to unarchive'); } else {submitbutton('unarchive', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('unarchive','','../images/admin/unarchive_f2.gif',1);"><IMG SRC="../images/admin/unarchive.gif" ALT="Unarchive" WIDTH="44" HEIGHT="47" BORDER="0" NAME="unarchive" HSPACE="10" VPSACE="0"></A></TD>
						...
						<TD WIDTH="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){alert('Please select a message to reply to'); } else {submitbutton('reply', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('reply','','../images/admin/reply_f2.gif',1);"><IMG SRC="../images/admin/reply.gif" NAME="reply" ALT="Reply" WIDTH="34" HEIGHT="47" BORDER="0" HSPACE="10" VPSACE="0"></A></TD>
						<TD WIDTH="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to edit'); } else {submitbutton('edit', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('edit','','../images/admin/edit_f2.gif',1);"><IMG SRC="../images/admin/edit.gif" NAME="edit" ALT="Edit" WIDTH="34" HEIGHT="47" BORDER="0" HSPACE="10" VPSACE="0"></A></TD>			    
						<TD WIDTH="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a message to delete'); } else if (confirm('Are you sure you want to delete selected items, this will also delete any subsequent replies')){ submitbutton('remove');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('delete','','../images/admin/delete_f2.gif',1);"><IMG SRC="../images/admin/delete.gif" ALT="Delete" WIDTH="34" HEIGHT="47" BORDER="0" NAME="delete" HSPACE="10" VPSACE="0"></TD>
						<TD WIDTH="470">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
