...
$message = "Hello $name,\n\n";
$message .= "You have received this email because you have requested to join a \n";
$message .= $fleetname . " sim. As such, the system has automatically generated a user ID and\n";
...
$message .= "You have been added because you requested to join the crew of a ".$fleetname." sim.\n";
...
$message .= "Thanks for simming in ".$fleetname.",\n";
