								...
								<tr>
									...
									<td>
										<select name="Database">
											...
											?>
												<option value="<?php echo $db[0]; ?>"><?php echo $db[0]; ?></option>
											<?php
											}
											?>
										</select>
...
\$live_site = 'http://".$_SERVER['SERVER_NAME'].str_replace("\\","/",dirname($_SERVER['PHP_SELF']))."';	// URL to your site
